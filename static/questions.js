const questions = [
    {
        id: 1,
        text: `You're working on a science fair project with Eve, Bob, Jessica, and Tyran. Everyone in your group is starting to get tired of Bob always strong-arming everyone and constantly making decisions without group input.
...
- How can you restore the group's trust with Suzanne?`,
        ...
        explanation: "In Survivor 48, Justin was forced by his tribe to go on a Journey where he failed a dice-rolling challenge and lost his vote. He chose not to tell anyone about this, which backfired at Tribal Council. A successful Shot in the Dark by Mary caused confusion about who to vote out, and Justin's missing vote became critical in a tie-breaker. Cedrek, unaware of Justin's lost vote, had to cast the deciding vote. Feeling betrayed, he sided against Justin, leading to Justin's elimination. Justin's secret-keeping and attempt to make a bold move ultimately cost him the game. This shows how important it is to be honest and transparent with your allies."
    },
    {
        id: 3,
        text: `You’re currently in a competition to see who can get the most balls into their basket in two minutes. You see one of your competitors, John and you see his basket snap in half, somehow. John has always been nice to you and you feel quite bad for him. You feel an urge to help. What do you do?
...
- How can you help John without completely destroying your chances at winning?`,
    ...
    {
        id: 4,
        text: `You’re working on an art project with your friend, Alice. You both work great, and your art project is looking quite amazing, to say the least. However, one day, Alice accidentally splashes a bit of paint on the project. She breaks down, crying, and she looks like she needs someone to comfort her. You’re very close to her, and you want to help her.
...
- How would you re-engage Alice back into the project after she's calmed down?`,
    ...
    {
        id: 5,
        text: `You're playing 1v1 Dodgeball, and you are feeling very, very competitive. You're about to win this game of dodgeball, and you spin around to fetch a dodgeball behind you. BAM. A dodgeball hits you straight in the back. You're out. You've lost. You're furious. What do you do?
